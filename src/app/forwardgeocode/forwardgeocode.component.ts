...
@Component({
  selector: 'app-forwardgeocode',
  templateUrl: './forwardgeocode.component.html',
  styleUrls: ['./forwardgeocode.component.css']
})
export class ForwardgeocodeComponent implements OnInit {
  ...
  forwardgeocode(data: any, event: any){
    if(event == "fetch")
    { 
      console.log('fetch');
    ...
    { 
      ...
      this.http.get("https://localhost:5001/V3/ForwardGeocodeValidation?Server=" + this.connectionString.Server + "&Database=" + this.connectionString.Database + 
